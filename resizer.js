...
exports.resizer = function (event, context) {
    ...
    // old slow code :)
    //sizes.forEach(function(item) {
    //    dstFileName = dstDir + '/' + item.prefix + baseName + '.jpg';
    //    im.convert(['-verbose', key,'-quality', 80, '-strip', '-interlace', 'Plane', '-resize', item.dimensions + '>', dstFileName]);
    //});
};